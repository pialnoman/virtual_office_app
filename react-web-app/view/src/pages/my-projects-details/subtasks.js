    ...
    axios
      ...
      .then(
        axios.spread((...responses) => {
          ...
          Array.from(subtask).forEach((assignee, idx) => {
      ...
      {project != undefined && (
        ...
        <CContainer>
          ...
          <CCol className='mt-3'>
            ...
            <CTabs
              //key={idx}
              activeTab={project[0].project.sub_task}
            >
              <CNav variant="tabs">
              ...
              {Array.from(project).map((pro,idx)=>(
                  <CTabPane data-tab={pro.project.sub_task}>
                    ...
                    <CCard key={b} className="card-ongoing-project">
                      <CCardBody className="details-project-body">
                        ...
                        <div className="mt-4 mb-2">
                          <h5 className="projectName mb-3">
                            Asssignee(s)-({Array.from(pro.assignees).length})

                          </h5>
                          <div className="file-show-ongoing-details row">
                            {project != undefined &&
                              Array.from(pro.assignees).map((item, idx2) => (
                                <div
                                  key={idx}
                        ...
                        <div className="mt-2 mb-2">
                          <div className="project-actions">
                            <CButton
                              ...
                              onClick={() => editInfoForm(pro.project)}
                            >
                            ...
                            <CButton
                              type="button"
                              onClick={() =>
                                delete_subtask(pro.project.work_package_index)
                              }
                      ...
                      {dateOver(pro.project.planned_delivery_date) == true && (
                        <CCardFooter row>
                          <CButton
                            type="button"
                            ...
                            size="sm"
                            onClick={() =>
                              console.log("subtask ", pro.project)
                              // history.push({
                              //   pathname: "/dashboard/WBS/create-wbs",
                              //   state: { task: pro.project },
                              // })
                            }
                          >
                            Create WBS
